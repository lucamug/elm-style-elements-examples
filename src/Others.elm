...
view _ =
    Element.layout stylesheet <|
        column None
            []
            [ el Title [ center, width (px 800), padding 10 ] <|
                text "Borders"
            , el Example1 [ center, width (px 800), padding 10 ] <|
                text """[ Border.all 1
, Color.border Color.red
]"""
            , el Example2 [ center, width (px 800), padding 10 ] <|
                text """[ Border.all 10
, Border.dashed
, Color.border Color.green
]"""
            , el Example3 [ center, width (px 800), padding 10 ] <|
                text """[ Border.all 5
, Border.rounded 50
, Border.dotted
, Color.border Color.lightOrange
            ...
            , el Title [ center, width (px 800), padding 10 ] <|
                text "Backgrounds"
            , el Example4 [ center, width (px 800), padding 10 ] <|
...
{-| A text layout
-}
viewTextLayout : List (Element Styles variation msg)
viewTextLayout =
...
viewRowLayouts : List (Element Styles variation msg)
viewRowLayouts =
...
viewGridLayout : List (Element Styles variation msg)
viewGridLayout =
...
viewNamedGridLayout : List (Element Styles variation msg)
viewNamedGridLayout =
